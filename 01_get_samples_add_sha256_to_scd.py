...
amp_session.auth = (client_id, amp_api_key)
...
response = requests.get(tg_url, params=tg_parameters)
...
for sample in items:
    ...
    response = amp_session.post(add_sha256_url, auth=(client_id, amp_api_key))
